/**
 * Script especifico para a pagina de edição de MetalThursday.
 *
 * @since 1.0
 * @version 1.0
 */
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    /**
     * Inicia os componentes de todas as secções.
     *
     * @since 1.0
     * @version 1.0
     */
    document.querySelectorAll('#sections-container .section-item').forEach(section => {
        initComponentsForSection(section);
    });

    /**
     * Inicia o seletor de nomeado.
     *
     * @since 1.0
     * @version 1.0
     */
    new NomineeSelector({
        ...
        oldestNominatedUrl: window.longestNotNominatedUrl
    });
     ...
     * @version 1.0
     */
    const mainForm = document.getElementById('edit-metalthursday-form');
    if (mainForm) {
        const mainFormValidator = new FormValidator(
            ...
            (validator) => {
                ...
                if (sections.length === 0) {
                    feedbackElement.textContent = 'É necessário adicionar pelo menos uma secção.';
        ...
        mainForm.addEventListener('submit', (e) => {
            ...
            const isStaticValid = mainFormValidator.validateAllStatic();
            const isCustomValid = mainFormValidator.customValidator ? mainFormValidator.customValidator(mainFormValidator) : true;
