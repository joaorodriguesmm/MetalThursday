 ...
 *
 * @param {HTMLElement} seccao Secção que deve ser inicializada.
 ...
 *
 * @param {ValidadorFormulario} validador Validador do formulário principal.
 * @param {Element|null} campo Campo que deve ser validado.
 ...
 *
 * @param {ValidadorFormulario} validador Validador do formulário.
 *
 ...
 *
 * @param {TomSelect|null} instancia Instância que deve receber a opção.
 * @param {unknown} valor Valor da opção.
 * @param {unknown} texto Texto apresentado.
 * @param {boolean} selecionar Indica se a opção deve ser selecionada.
 *
 * @returns {void}
 *
 * @since 2.0.0
 ...
 *     Inicializador dos campos Tom Select.
 *
 * @returns {Array<object>} Configurações dos modais.
 *
 * @since 2.0.0
 * @version 1.0.0
 */
 ...
 * @version 2.0.0
 */
function inicializarPaginaEdicaoMetalThursday() {
...
document.addEventListener(
    'DOMContentLoaded',
    inicializarPaginaEdicaoMetalThursday,
    {
        once: true,
    },
);
