...
final class AcessoUtilizadoresTest extends TestCase
{
    ...
    /**
     * Confirma que estados parciais de suspensão são rejeitados.
     *
    ...
    /**
     * Fornece estados atuais incompatíveis com uma suspensão coerente.
     *
    ...
    public static function fornecerEstadosParciaisSuspensao(): array
    {
        return [
            ...
            'responsável sem data nem motivo' => [
                false,
                null,
                true,
            ],
    ...
    /**
     * Cria um utilizador afetado e um superadministrador responsável.
     *
